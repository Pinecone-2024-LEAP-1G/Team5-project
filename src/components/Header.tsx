        ...
        return(
             ...
             <div className=" mx-auto flex max-w-[1240px] h-[80px] items-center justify-between ">
                <div className="flex w-200 h-[28px] items-center ">
                      ...
                      <p className="text-white w-[67px] h-[28px] ml-[40px] cursor-pointer">Ангилал</p>
                 </div>
                 <div className="flex " >
                ...
                <div className="flex">
                    ...
                    <Button className="rounded-full mx-3 border-[#2563EB] text-white hover:bg-[#2563EB]  " variant="outline">Бүртгүүлэх</Button>
                    <Button className="rounded-full mx-3 bg-[#2563EB] text-white hover:border-[#2563EB] " variant="default">Нэвтрэх</Button>
                </div>
             </div>
